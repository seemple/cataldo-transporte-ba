...
export default function SidebarCart({show,onClose}){
    ...
    return(
        ...
        <div className={`relative ${show ? "z-40" : "z-0"}`} aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
            
            <div className="overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className={`pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 ${show ? "transition translate-x-0 transform ease-in-out duration-500 sm:duration-700" : "transform transition translate-x-full ease-in-out duration-500 sm:duration-700"}`}>
